...
#  tar -czvf fts-3.2.5-2.tar.gz fts3
...
%changelog
* Tue Feb 04 2014 Alejandro Alvarez <aalvarez@cern.ch> - 3.2.5-4
  - introduced dist back in the release
* Tue Jan 14 2014 Alejandro Alvarez <aalvarez@cern.ch> - 3.2.5-3
  - using cmake28
* Mon Jan 13 2014 Alejandro Alvarez <aalvarez@cern.ch> - 3.2.5-2
