...
BuildRequires:  gfal2-devel >= 2.21.1
...
Requires: fts-libs%{?_isa} = %{version}-%{release}
Requires: gfal2%{?_isa} >= 2.21.1
Requires: gfal2-plugin-gridftp%{?_isa} >= 2.21.1
Requires: gfal2-plugin-http%{?_isa} >= 2.21.1
Requires: gfal2-plugin-srm%{?_isa} >= 2.21.1
