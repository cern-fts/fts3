...
BOOST_FIXTURE_TEST_CASE (TEST_NAME, Fts3ConfigGet)
{
...
int main (int argc, char** argv)
{
    ...
    try
    {
        FTS3_CLI_NAMESPACE::Fts3ConfigGet::Execute(argc, argv);
    }
    catch(...)
    {
