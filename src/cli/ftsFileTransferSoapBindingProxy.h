/* ftsFileTransferSoapBindingProxy.h
...
#ifndef ftsFileTransferSoapBindingProxy_H
#define ftsFileTransferSoapBindingProxy_H
#include "ftsH.h"

class SOAP_CMAC FileTransferSoapBindingProxy : public soap
{ public:
	/// Endpoint URL of service 'FileTransferSoapBindingProxy' (change as needed)
	const char *soap_endpoint;
	/// Constructor
	FileTransferSoapBindingProxy();
	/// Constructor with copy of another engine state
	FileTransferSoapBindingProxy(const struct soap&);
	/// Constructor with engine input+output mode control
	FileTransferSoapBindingProxy(soap_mode iomode);
	/// Constructor with engine input and output mode control
	FileTransferSoapBindingProxy(soap_mode imode, soap_mode omode);
	/// Destructor frees deserialized data
	virtual	~FileTransferSoapBindingProxy();
	/// Initializer used by constructor
	virtual	void FileTransferSoapBindingProxy_init(soap_mode imode, soap_mode omode);
