...
BrokerConfig::BrokerConfig(const std::string &path)
{
    ...
    opt_desc.add_options()(
        ...
        "EVENT_TRIGGER",
        po::value<std::string>()->default_value("transfer.fts_event_collector"),
        "Single-server destination for transfer completion messages in the whole cluster")(
        "TTL",
...
std::string BrokerConfig::GetEventTriggerDestination() const
{
    return vm["EVENT_TRIGGER"].as<std::string>();
}
