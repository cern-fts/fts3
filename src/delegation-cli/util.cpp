...
int glite_check_versions(const char *client_ver, const char *service_ver)
{
	...
	s_v1 = strtok(sv, "."); s_v2 = strtok(NULL, "."); s_v3 = strtok(NULL, ".");
	c_v1 = strtok(cv, "."); c_v2 = strtok(NULL, "."); c_v3 = strtok(NULL, ".");
	...
	ns_v1 = atoi(s_v1); ns_v2 = atoi(s_v2); ns_v3 = atoi(s_v3);
	nc_v1 = atoi(c_v1); nc_v2 = atoi(c_v2); nc_v3 = atoi(c_v3);
	free(sv);
	free(cv);
