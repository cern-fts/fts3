...
public:
     ...
     */
    bool isNull() const throw () { return (-1 == m_handle)?true:false;}
     ...
     */
    int * get() throw () { return &(m_handle);}

    /**
     * Return the handle
     */
    int operator()() const throw (){return m_handle;}
    
    /**
     * Return and release the handle
     */
    int release() throw() {int h = m_handle; m_handle = -1; return h;}
