...
template <typename T>
struct NullPointer {
	static typename Pointer<T>::Shared Shared() {return typename Pointer<T>::Shared();}
	static typename Pointer<T>::Scoped Scoped() {return typename Pointer<T>::Scoped();}
	static typename Pointer<T>::ScopedArray ScopedArray() {return typename Pointer<T>::ScopedArray();}
	static typename Pointer<T>::SharedArray SharedArray() {return typename Pointer<T>::SharedArray();}
	static typename Pointer<T>::Raw Raw() {return NULL;}
};
