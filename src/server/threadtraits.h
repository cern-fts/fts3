...
#ifndef FTS_SERVER_THREADTRAITS_H
#define FTS_SERVER_THREADTRAITS_H

#ifdef __FTS3_THREADTRAITS_H_GUARD__
  #error __FTS3_THREADTRAITS_H_GUARD__ should not be defined here!
#endif

#define __FTS3_THREADTRAITS_H_GUARD__
...
#undef __FTS3_THREADTRAITS_H_GUARD__

#endif /* FTS_SERVER_THREADTRAITS_H */
