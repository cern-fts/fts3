...
#ifndef FTS3_SERVER_MONITOROBJECT_H
#define FTS3_SERVER_MONITOROBJECT_H

/** \file monitorobject.h Implementation of MonitorObject class. */

#include "server_dev.h"
#include "threadtraits.h"

START_FTS3_SERVER_NAMESPACE
 ...
 * {
 * FTS3_SERVER_MONITOR_START_CRITICAL
 *     // Do something
 *     return 0;
 * FTS3_SERVER_MONITOR_END_CRITICAL
 * }
 *
...
/// The name of the lock variable that is set by FTS3_SERVER_MONITOR_START_CRITICAL.
#define FTS3_SERVER_MONITOR_LOCK __lock__

/// Opens a critical (protected) section. It must be closed by a corresponding FTS3_SERVER_MONITOR_END_CRITICAL.
...
#define FTS3_SERVER_MONITOR_START_CRITICAL { ThreadTraits::LOCK FTS3_SERVER_MONITOR_LOCK(this->_monitor_lock);

/// Opens a "static" critical section (locks all the objects of a given class). 
#define FTS3_SERVER_MONITOR_START_STATIC_CRITICAL { ThreadTraits::LOCK FTS3_SERVER_MONITOR_LOCK(_static_monitor_lock());

/// Closes a critical (protected) section. Used for static sections as well.
#define FTS3_SERVER_MONITOR_END_CRITICAL }

FTS_SERVER_NAMESPACE_END

#endif /* FTS3_SERVER_MONITOROBJECT_H */
