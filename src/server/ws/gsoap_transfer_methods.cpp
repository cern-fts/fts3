...
int fts3::log__GetData(struct soap* soap, struct log__GetDataResponse &_param_36) {
	...
	fstream file ("/home/simonm/test.txt");
	cout << file.is_open() << endl;

	_param_36.parameters = soap_new_log__GetDataResponseType(soap, -1);

	log__Data* log = soap_new_log__Data(soap, -1);
	log->xop__Include.__ptr = (unsigned char*) &file;
	log->xop__Include.__size = 5;
