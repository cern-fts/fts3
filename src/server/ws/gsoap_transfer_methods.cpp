...
//
//		InternalLogRetriever retriever (*it);
//		retriever.getInternalLogs(jobId);
//	}
//
//	// TODO add the logs to common gzip archive
//	// ...
//
//	return SOAP_OK;
//
...
//	fstream* file = new fstream(jobId.c_str(), ios_base::in);
//	if (!file->is_open()) {
...
//	log->xop__Include.__size = 0; // the size of the file is unknown use http chunk
