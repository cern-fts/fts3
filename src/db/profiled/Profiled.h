...
public:
    ...
    void getSubmittedJobs(std::vector<TransferJobs*>& jobs, const std::string & vos);

    void getByJobId(std::vector<TransferJobs*>& jobs, std::map< std::string, std::list<TransferFiles*> >& files, bool reuse);
