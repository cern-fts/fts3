...
CREATE TABLE t_se (
  ...
  eviction                CHAR(1)         NULL,
  tpc_support             VARCHAR(10)     NULL,
  skip_eviction CHAR(1)                   NULL,
  tape_endpoint CHAR(1)                   NULL,
  PRIMARY KEY (storage)
);
