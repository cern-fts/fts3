...
--
-- Host: dbod-fts-dev.cern.ch    Database: fts_schema_9_1_0
-- ------------------------------------------------------
...
INSERT INTO `t_schema_vers` VALUES (9,0,0,'Schema 9.0.0'),(9,1,0,'FTS-2007: Implement \"overwrite-when-only-on-disk\" feature');
...
INSERT INTO `t_se` VALUES ('*',NULL,NULL,NULL,NULL,NULL,200,NULL,200,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `t_server_config` VALUES (0,0,0,0,'*',NULL,NULL);
...
--
-- Dumping data for table `t_token_provider`
--

LOCK TABLES `t_token_provider` WRITE;
/*!40000 ALTER TABLE `t_token_provider` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_token_provider` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-08-01 10:35:24
