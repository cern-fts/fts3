...
-- SELECT 'CREATE SYNONYM ' || sequence_name || ' FOR fts3_dev.' || sequence_name || ';' FROM user_sequences;
--
-- As the fts3 user:
--
CREATE SYNONYM T_SERVER_SANITY FOR fts3_dev.T_SERVER_SANITY;
CREATE SYNONYM T_SERVER_CONFIG FOR fts3_dev.T_SERVER_CONFIG;
CREATE SYNONYM T_OPTIMIZE_MODE FOR fts3_dev.T_OPTIMIZE_MODE;
CREATE SYNONYM T_OPTIMIZE FOR fts3_dev.T_OPTIMIZE;
CREATE SYNONYM T_OPTIMIZER_EVOLUTION FOR fts3_dev.T_OPTIMIZER_EVOLUTION;
CREATE SYNONYM T_CONFIG_AUDIT FOR fts3_dev.T_CONFIG_AUDIT;
CREATE SYNONYM T_DEBUG FOR fts3_dev.T_DEBUG;
CREATE SYNONYM T_CREDENTIAL_CACHE FOR fts3_dev.T_CREDENTIAL_CACHE;
CREATE SYNONYM T_CREDENTIAL FOR fts3_dev.T_CREDENTIAL;
CREATE SYNONYM T_CREDENTIAL_VERS FOR fts3_dev.T_CREDENTIAL_VERS;
CREATE SYNONYM T_SE FOR fts3_dev.T_SE;
CREATE SYNONYM T_SE_ACL FOR fts3_dev.T_SE_ACL;
CREATE SYNONYM T_GROUP_MEMBERS FOR fts3_dev.T_GROUP_MEMBERS;
CREATE SYNONYM T_LINK_CONFIG FOR fts3_dev.T_LINK_CONFIG;
CREATE SYNONYM T_SHARE_CONFIG FOR fts3_dev.T_SHARE_CONFIG;
CREATE SYNONYM T_ACTIVITY_SHARE_CONFIG FOR fts3_dev.T_ACTIVITY_SHARE_CONFIG;
CREATE SYNONYM T_BAD_SES FOR fts3_dev.T_BAD_SES;
CREATE SYNONYM T_BAD_DNS FOR fts3_dev.T_BAD_DNS;
CREATE SYNONYM T_SE_PAIR_ACL FOR fts3_dev.T_SE_PAIR_ACL;
CREATE SYNONYM T_VO_ACL FOR fts3_dev.T_VO_ACL;
CREATE SYNONYM T_JOB FOR fts3_dev.T_JOB;
CREATE SYNONYM T_FILE FOR fts3_dev.T_FILE;
CREATE SYNONYM T_FILE_RETRY_ERRORS FOR fts3_dev.T_FILE_RETRY_ERRORS;
CREATE SYNONYM T_FILE_SHARE_CONFIG FOR fts3_dev.T_FILE_SHARE_CONFIG;
CREATE SYNONYM T_STAGE_REQ FOR fts3_dev.T_STAGE_REQ;
CREATE SYNONYM T_HOSTS FOR fts3_dev.T_HOSTS;
CREATE SYNONYM T_OPTIMIZE_ACTIVE FOR fts3_dev.T_OPTIMIZE_ACTIVE;
CREATE SYNONYM T_SCHEMA_VERS FOR fts3_dev.T_SCHEMA_VERS;
CREATE SYNONYM T_FILE_BACKUP FOR fts3_dev.T_FILE_BACKUP;
CREATE SYNONYM T_JOB_BACKUP FOR fts3_dev.T_JOB_BACKUP;
CREATE SYNONYM T_PROFILING_INFO FOR fts3_dev.T_PROFILING_INFO;
CREATE SYNONYM T_PROFILING_SNAPSHOT FOR fts3_dev.T_PROFILING_SNAPSHOT;

CREATE SYNONYM FILE_FILE_ID_SEQ FOR fts3_dev.FILE_FILE_ID_SEQ;
CREATE SYNONYM SE_ID_INFO_SEQ FOR fts3_dev.SE_ID_INFO_SEQ;
CREATE SYNONYM T_OPTIMIZE_AUTO_NUMBER_SEQ FOR fts3_dev.T_OPTIMIZE_AUTO_NUMBER_SEQ;
