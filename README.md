...
## References
* Web page: https://fts.web.cern.ch/fts/
* Documentation: https://fts3-docs.web.cern.ch/fts3-docs/
* Developers guide: https://fts3-docs.web.cern.ch/fts3-docs/docs/developers.html
* Ticket handling in [JIRA](https://its.cern.ch/jira/browse/FTS)
* Continuous integration in [Gitlab-CI](https://gitlab.cern.ch/fts/fts3/-/pipelines)
* Support: fts-support@cern.ch
